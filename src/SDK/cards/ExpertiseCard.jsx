...
const ExpertiseCard = ({ title, description, imageUrl }) => {
  ...
  return (
    <div
      className="px-4 md:px-5 border bg-accent-white border-accent-white  shadow-lg tech-card rounded-2xl py-9 "
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <div className="flex mb-2 justify-between">
        <p className="text-accent-black font-bold text-base md:text-xl">
          {title}
        </p>
