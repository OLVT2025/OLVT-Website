...
const ExpertiseCard = ({ title, description, imageUrl }) => {
  ...
  return (
    <div className="px-4 md:px-5 border bg-accent-white border-accent-white  shadow-lg rounded-2xl py-9 ">
      <div className="flex mb-2 justify-between">
        <p className="text-accent-black font-bold text-base md:text-xl">{title}</p>
